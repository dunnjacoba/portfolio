...
const UserMessage = (props) => {
    if (props.message.senderId === props.toUser.userId) {
        return (
            <li className={classnames('clearfix', { odd: props.message.senderId === props.toUser.userId })}>
        ...
        return (
            <li className={classnames('clearfix', { even: props.message.recipientId === props.currentUser?.userId })}>
                <div className="chat-avatar" height="50">
